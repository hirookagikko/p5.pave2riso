 ...
 * ```
 */
export declare function percentage(value: number): Percentage;
/**
 ...
 * @returns Branded Percentage value
 */
export declare function unsafePercentage(value: number): Percentage;
/**
 ...
 */
export declare function clampPercentage(value: number): Percentage;
export {};
