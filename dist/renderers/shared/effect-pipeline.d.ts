...
import { type DiagonalBufferConfig } from '../../utils/diagonal-buffer.js';
/**
 ...
 * ```
 */
export declare const applyEffectPipeline: (baseG: p5.Graphics, filter: FilterConfig | FilterConfig[] | null | undefined, halftone: HalftoneConfig | null | undefined, dither: DitherConfig | null | undefined, canvasSize: [number, number], pipeline: GraphicsPipeline) => EffectPipelineResult;
/**
 ...
 * ```
 */
export declare const applyEffectPipelineWithOffset: (baseG: p5.Graphics, filter: FilterConfig | FilterConfig[] | null | undefined, halftone: HalftoneConfig | null | undefined, dither: DitherConfig | null | undefined, canvasSize: [number, number], pipeline: GraphicsPipeline, baseX: number, baseY: number) => EffectPipelineResult;
/**
 ...
 */
export declare const hasEffects: (filter: FilterConfig | FilterConfig[] | null | undefined, halftone: HalftoneConfig | null | undefined, dither: DitherConfig | null | undefined) => boolean;
