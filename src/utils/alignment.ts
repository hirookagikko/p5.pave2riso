 ...
 */
export const normalizeAlignX = (alignX: AlignX): number => {
  ...
  switch (alignX) {
    ...
    case 'right':
      return 1
    default: {
      const _exhaustiveCheck: never = alignX
 ...
 */
export const normalizeAlignY = (alignY: AlignY): number => {
  ...
  switch (alignY) {
    ...
    case 'bottom':
      return 1
    default: {
      const _exhaustiveCheck: never = alignY
      return _exhaustiveCheck
    }
  }
}
