...
/**
 * Path type from pave.js
 * Since pave.js doesn't provide TypeScript types, we'll use any for the Path constructor
 * but wrap all operations in type-safe interfaces.
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any
type PathConstructor = any

/**
 * Get Path constructor from global context
 */
const getPathConstructor = (): PathConstructor => {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
